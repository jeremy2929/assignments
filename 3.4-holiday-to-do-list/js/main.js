...
//  var $divElementAdd = $body.find("[data-js='theList']");
  ...
  var $checkElement = $body.find("[data-js='check']");
  ...
  /*    var $newCheckBoxElement = $("<input>")
      ...
      ;
      */
      var $newCheckBoxElementClick = $("<a href ='#'>")
          .attr({
            class: "click"

          })
        ;
      var $newCheckBoxElementClickImage = $("<img>")
          .attr({
             class: "itemsCheckBox",
             "data-js": "checkbox",
             id: "clickit",
      ...
      $newCheckBoxElementClick.append($newCheckBoxElementClickImage);
    //  console.log($newCheckBoxElement);
/*      var $newCheckBoxElement = $("<button>")
        .attr({
          class: "itemsCheckBox",
          "data-js": "checkbox",
        })
  ...
  //      .append($newCheckBoxElementClick)
        .append($newCheckBoxElementClick)
  //      .append($newCheckBoxElementClickImage)
  ...
  $body.on("click","[data-js='checkbox']",function(e){
    ...
    //$checkBoxElement.attr({"img src":  "check.jpg"});
  //  $checkBoxElement.image("check.jpg");
  });
