...
//    var $itemsDescriptionElement =$.next();
    // "[data-js='itemsDescription']"
    $(this).next().addClass("itemsDescriptionStrike");
    $(this).next("p.itemsAmount").addClass("itemsAmountStrike");
console.log($(this).next("p.itemsAmount"));
    /* use jquery to find sibling description based on (this)
    add class to found sibling
    */
