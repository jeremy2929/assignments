...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function(){
	  ...
	  var $squareElement = $body.find("[data-js='squareElement']");
	  ...
	  $squareElement.on("click", function(){
	    ...
	    if (needReset===false){
	      ...
	      var position = alt-1;
	      // ensure the sdquare clicked is empty (contains *, not X or O)
	      if (boardArray[position]==="*"){
	        // fill square with correct player symnol X or O
	        $clickedElement.text(player);
	      ...
	      // loop through all values of large string containing array values
	      for (var i = 0; i<25 ; i+=3){
	        ...
	        if (check === "xxx" || check === "ooo"){
	          ...
	          // convert text in square to uppercase to highlight first of 3 in a row
	          $highlightElement.text(winningPlayer.toUpperCase());
	          // change class of square to change color to highlight the win
	          $highlightElement.attr({class: "redSquare"});
	          //--------------------------------------------------------------------------------------
	          ...
	          // locate which HTML element contains part of the 3 in a row using alt HTML
	          var $highlightElement=$body.find(winHTML);
	          // convert text in square to uppercase to highlight second of 3 in a row
	          $highlightElement.text(winningPlayer.toUpperCase());
	          // change class of square to change color to highlight the win
	          $highlightElement.attr({class: "redSquare"});
	          //--------------------------------------------------------------------------------------
	          ...
	          var $highlightElement=$body.find(winHTML);
	          // convert text in square to uppercase to highlight third of 3 in a row
	          $highlightElement.text(winningPlayer.toUpperCase());
	          // change class of square to change color to highlight the win
	          $highlightElement.attr({class: "redSquare"});
	          //--------------------------------------------------------------------------------------
